...
TEXT_FOLDER = "output_texts"        # Folder chứa các file .txt đã chuẩn hóa từ OpenAI
OUTPUT_FOLDER = "chunks_json"   # Folder lưu các file .json đã chunk
CHUNK_WORD_LIMIT = 400            # Số lượng từ mỗi đoạn


def clean_text(text: str) -> str:
    """Làm sạch text: loại bỏ khoảng trắng thừa, chuẩn hóa dòng"""
    text = text.replace("\r", "")
    return re.sub(r"\n{2,}", "\n\n", text.strip())
